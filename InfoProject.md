...
- **Rota Frontend**: `/cadastro` (renderiza `templates/Tcc/Login/cadastro.html`)
...
- **Rota Frontend**: `/login` (renderiza `templates/Tcc/Login/login.html`)
...
- **Rota Frontend**: `/` (renderiza `templates/Tcc/index.html`)
...
- **Rota Frontend**: `/ajuda/pedir` (renderiza `templates/Tcc/Ajuda/pedir_ajuda.html`)
